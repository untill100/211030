...
var floorMaterial = new THREE.MeshPhongMaterial({ color: 0x000011, opacity: 0.9, transparent: true, side: THREE.DoubleSide });
...
const figure_material = new THREE.MeshPhongMaterial({ color: 0x0000ff, bumpScale: 0.002, map: texture });
...
const skyBoxMaterial = new THREE.MeshPhongMaterial({ color: 0x0000ff, side: THREE.DoubleSide, map: skyBox_texture });
...
// WALL: Front
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(1, 1);
texture.flipY = false;
...
// WALL: Right
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture2.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
...
// WALL: Left
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture4.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
var wallGeometry = new THREE.PlaneGeometry(map_depth, map_width, 10, 10);
