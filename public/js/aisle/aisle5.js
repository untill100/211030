...
var floorMaterial = new THREE.MeshPhongMaterial({ color: 0x111111, opacity: 0.9, transparent: true, side: THREE.DoubleSide });
...
const figure_material = new THREE.MeshPhongMaterial({ color: 0x555555, bumpScale: 0.002, map: texture });
...
const skyBoxMaterial = new THREE.MeshPhongMaterial({ color: 0xffffff, side: THREE.DoubleSide, map: skyBox_texture });
...
// WALL: Front
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture17.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(1, 1);
texture.flipY = false;
...
// WALL: Right
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture18.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
...
// WALL: Back
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture19.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
var wallGeometry = new THREE.PlaneGeometry(map_width, map_width, 10, 10);
...
// WALL: Left
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture20.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
var wallGeometry = new THREE.PlaneGeometry(map_depth, map_width, 10, 10);
