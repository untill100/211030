...
var floorMaterial = new THREE.MeshPhongMaterial({ color: 0x001111, opacity: 0.9, transparent: true, side: THREE.DoubleSide });
...
const figure_material = new THREE.MeshPhongMaterial({ color: 0x00ffff, bumpScale: 0.002, map: texture });
...
const skyBoxMaterial = new THREE.MeshPhongMaterial({ color: 0x00ffff, side: THREE.DoubleSide, map: skyBox_texture });
...
// WALL: Front
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture13.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(1, 1);
texture.flipY = false;
...
// WALL: Right
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture14.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
...
// WALL: Back
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture15.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
var wallGeometry = new THREE.PlaneGeometry(map_width, map_width, 10, 10);
...
// WALL: Left
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture16.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
var wallGeometry = new THREE.PlaneGeometry(map_depth, map_width, 10, 10);
