...
var floorMaterial = new THREE.MeshPhongMaterial({ color: 0x110011, opacity: 0.9, transparent: true, side: THREE.DoubleSide });
...
// WALL: Front
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture9.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(1, 1);
texture.flipY = false;
...
// WALL: Right
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture10.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
...
// WALL: Left
var texture = new THREE.TextureLoader().load('public/assets/textures/aisle/aisle_texture12.png');
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(-1, 1);
texture.flipY = true;
var wallGeometry = new THREE.PlaneGeometry(map_depth, map_width, 10, 10);
