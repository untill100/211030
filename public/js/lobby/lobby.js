...
var floor_texture = new THREE.TextureLoader().load('public/assets/textures/floor_text_1.jpg');
// floor_texture.wrapS = floor_texture.wrapT = THREE.RepeatWrapping;
// floor_texture.repeat.set(1, 1);
floor_texture.flipY = false;

var floorGeometry = new THREE.PlaneGeometry(map_width, 730 - 50, 10, 10);
var floorMaterial = new THREE.MeshBasicMaterial({ color: 0xffffff, opacity: 0.7, side: THREE.DoubleSide, map: floor_texture });
var floor = new THREE.Mesh(floorGeometry, floorMaterial);

floor.position.y = 0;
floor.rotation.x = Math.PI / 2;
floor.position.z = 251 / 2 + 25;

scene.add(floor);

// FLOOR 2
var floor_texture = new THREE.TextureLoader().load('public/assets/textures/floor.jpg');
var floorGeometry = new THREE.PlaneGeometry(map_width, 251, 10, 10);
var floorMaterial = new THREE.MeshBasicMaterial({ color: 0xffffff, opacity: 0.7, side: THREE.DoubleSide, map: floor_texture });
var floor = new THREE.Mesh(floorGeometry, floorMaterial);

floor.position.y = 0;
floor.rotation.x = Math.PI / 2;
floor.position.z = - 730 / 2;
...
var floor_texture = new THREE.TextureLoader().load('public/assets/textures/ceiling.jpg');
// floor_texture.wrapS = floor_texture.wrapT = THREE.RepeatWrapping;
floor_texture.repeat.set(1, 1);
floor_texture.flipY = false;
var floorGeometry = new THREE.PlaneGeometry(map_width, 730, 10, 10);
var floorMaterial = new THREE.MeshBasicMaterial({ color: 0xffffff, opacity: 1, map: floor_texture, side: THREE.DoubleSide });
var floor = new THREE.Mesh(floorGeometry, floorMaterial);

floor.position.y = 227;
floor.rotation.x = -Math.PI / 2;
floor.position.z = 251 / 2;
...
const skyBoxMaterial = new THREE.MeshBasicMaterial({ color: 0xffffff, side: THREE.DoubleSide, });
...
var wallGeometry = new THREE.PlaneGeometry(map_width, map_height, 10, 10);
var wallMaterial = new THREE.MeshBasicMaterial({ color: 0x796485, bumpScale: 0.002, opacity: 0.7, side: THREE.DoubleSide, map: texture });
var wall = new THREE.Mesh(wallGeometry, wallMaterial);

wall.rotation.x = Math.PI;
wall.position.x = 0;
wall.position.y = map_height / 2;
...
var wallGeometry = new THREE.PlaneGeometry(map_width, map_height, 10, 10);
var wallMaterial = new THREE.MeshBasicMaterial({ color: 0x6c6668, bumpScale: 0.002, opacity: 0.7, side: THREE.DoubleSide, map: texture });
var wall = new THREE.Mesh(wallGeometry, wallMaterial);

wall.rotation.x = Math.PI;
wall.position.x = 0;
wall.position.y = map_height / 2;
wall.position.z = -239.5;

WALLS.push(wall);
scene.add(wall);

// kaidan
var floor_texture = new THREE.TextureLoader().load('public/assets/textures/kaidan_texture.jpg');
var wallGeometry = new THREE.BoxGeometry(329, 15, 50, 10);
var wallMaterial = new THREE.MeshBasicMaterial({ color: 0xffffff, opacity: 0.7, side: THREE.DoubleSide, map: floor_texture });
var wall = new THREE.Mesh(wallGeometry, wallMaterial);

wall.rotation.x = Math.PI;
wall.position.x = 0;
wall.position.y = 7.5;
wall.position.z = -239.5 + 50 / 2;
...
var wallGeometry = new THREE.PlaneGeometry(map_depth, map_height, 10, 10);
var wallMaterial = new THREE.MeshBasicMaterial({ color: 0x6c6668, bumpScale: 0.002, opacity: 0.7, side: THREE.DoubleSide, map: texture });
var wall = new THREE.Mesh(wallGeometry, wallMaterial);
...
var wallGeometry = new THREE.PlaneGeometry(251, map_height, 10, 10);
var wallMaterial = new THREE.MeshBasicMaterial({ color: 0x796485, bumpScale: 0.002, opacity: 0.7, side: THREE.DoubleSide, map: texture });
var wall = new THREE.Mesh(wallGeometry, wallMaterial);

wall.rotation.y = Math.PI / 2;
wall.position.x = map_width / 2 - 1;
wall.position.y = map_height / 2;
wall.position.z = -239.5 - 1 - 251 / 2;
...
// DOOR
var doorGeometry = new THREE.BoxGeometry(120, 227 - 10, 3);
var doorMaterial = new THREE.MeshBasicMaterial({ color: 0x000000, side: THREE.DoubleSide });
var door = new THREE.Mesh(doorGeometry, doorMaterial);

door.position.x = -60;
door.position.y = 227 / 2 - 10;
door.position.z = map_depth / 2 + 1;
...
// DOOR
var doorGeometry = new THREE.BoxGeometry(80, 227 - 10, 3);
var doorMaterial = new THREE.MeshBasicMaterial({ color: 0x000000, side: THREE.DoubleSide });
var door = new THREE.Mesh(doorGeometry, doorMaterial);

door.position.x = map_width / 2 - 40 - 27;
door.position.y = 227 / 2 - 10;
door.position.z = -239.5 - 1;
door.rotation.x = Math.PI;
// door.rotation.y = -Math.PI / 2;
...
var texture = new THREE.TextureLoader().load(`public/assets/textures/people.jpg`);
texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
texture.repeat.set(1, 1);
texture.needsUpdate = true;

cubeMaterialArray.push(new THREE.MeshBasicMaterial({ color: cube_color, bumpScale: 0.002 }));
cubeMaterialArray.push(new THREE.MeshBasicMaterial({ color: cube_color, bumpScale: 0.002 }));
cubeMaterialArray.push(new THREE.MeshBasicMaterial({ color: cube_color, bumpScale: 0.002 }));
cubeMaterialArray.push(new THREE.MeshBasicMaterial({ color: cube_color, bumpScale: 0.002 }));
cubeMaterialArray.push(new THREE.MeshBasicMaterial({ color: cube_color, bumpScale: 0.002, map: texture, transparent: false, opacity: 0.7 }));
cubeMaterialArray.push(new THREE.MeshBasicMaterial({ color: cube_color, bumpScale: 0.002 }));

var cubeGeometry = new THREE.BoxGeometry(25, 175, 25);
var cubeMaterial = cubeMaterialArray;
const cube = new THREE.Mesh(cubeGeometry, cubeMaterial);

cube.position.x = 0;
cube.position.y = 170 / 2;
cube.position.z = 100;

scene.add(cube);

// CUBE - VERTICES (NOT USE)
...
function check_collision_door(_player, _door) {
    ...
    if (answer) {
        ...
        setTimeout(() => {
            window.location.href = "/aisle1";
        }, 1000);
    }
}

// 3. COLLISION EVENTS - FIXED OBJECT
...
window.addEventListener('resize', () => {
    ...
    popup.style.bottom = document.querySelector("#main-footer").offsetHeight + "px";

    // interaction_btn
    if (window.innerWidth < 1000) {
        const interaction_btn = document.querySelector("#interaction-btn");
        interaction_btn.style.left = (window.innerWidth - interaction_btn.offsetWidth) / 2 + "px";
        interaction_btn.style.bottom = document.querySelector("#main-footer").offsetHeight * 2 + document.querySelector("#mobile-keyboard").offsetHeight + "px";
    } else {
        const interaction_btn = document.querySelector("#interaction-btn");
        interaction_btn.style.left = (window.innerWidth - interaction_btn.offsetWidth) / 2 + "px";
        interaction_btn.style.bottom = document.querySelector("#main-footer").offsetHeight + "px";
    }
}, false);
...
function handle_camera() {
    ...
    camera.position.y = cameraOffset.y - 60;
