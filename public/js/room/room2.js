...
var floorMaterial = new THREE.MeshPhongMaterial({ color: 0x111100, side: THREE.DoubleSide, opacity: 0.9, transparent: true });
...
var wallMaterial = new THREE.MeshPhongMaterial({ color: 0xffff00, bumpScale: 0.002, opacity: 0.5, transparent: true, side: THREE.DoubleSide, map: texture });
